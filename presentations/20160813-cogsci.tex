...
\renewcommand{\inserttotalframenumber}{26}
...
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{gricean}
...
%\begin{center}
%\resizebox{!}{.7\paperheight}{\input{replicator.tex}}
%\end{center}
...
\begin{frame}
	\frametitle{II. Iterated learning (mutator dynamics)}
...
\begin{frame}
\begin{itemize}\itemsep1em
\item $P(t_i)$ controlled by parameter $c \in [0,1]$ 
\item Signaling: $\lambda$, $\alpha$, literal or pragmatic
\item Learning \alert{c}, \alert{l}, datum length k, \# of sequences of length k
\end{itemize}
\end{frame}
...
\begin{itemize} 
  ...
  \item Relation between bounds and learnability 
\end{itemize}
\end{frame}
