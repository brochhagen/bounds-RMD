...
\subparagraph{(IV) Parametrized learning} $Q_{ij} \propto [\sum_d P(d|t_i) P(t_j|d)]^l$, where $l =1$ corresponds to probability matching and, as $l$ increases towards infinity, to MAP.  	      
