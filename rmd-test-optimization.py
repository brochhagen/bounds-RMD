...
def alternate_m_permutation(m,n):
...
def get_obs(k):
    ...
    print 'Length of observations', len(out)
...
def get_obs_likelihood(k):
    ...
    pOut1alt = alternate_m_permutation(out1,lexical_pairs) #combine literal lexica
    pOut2alt = alternate_m_permutation(out2,lexical_pairs) #combine gricean lexica
    print 'Test alternates'
    print 'out1'
    print pOut1alt == pOut1
    print np.all(pOut1alt == pOut1)

    print 'out2'
    print pOut2alt == pOut2

    print np.all(pOut2alt == pOut2)
